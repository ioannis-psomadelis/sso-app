...
export function Callback({ handleCallback, isAuthenticated, isLoading }: CallbackProps) {
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <Card className="w-full max-w-sm text-center">
          <CardHeader className="space-y-4">
            ...
            <div>
              <CardTitle className="text-xl text-green-600">Welcome to {theme.name}!</CardTitle>
