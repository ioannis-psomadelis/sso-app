...
// TaskFlow theme - violet/purple accents
const theme = {
  ...
  const getEventConfig = (type: string) => {
    switch (type) {
      ...
      case 'redirect_to_idp':
        return { icon: ArrowRight, color: 'text-violet-500', bg: 'bg-violet-500/10', border: 'border-violet-500/30' };
      case 'code_received':
      ...
      case 'api_call':
        return { icon: Activity, color: 'text-cyan-500', bg: 'bg-cyan-500/10', border: 'border-cyan-500/30' };
      case 'logout':
