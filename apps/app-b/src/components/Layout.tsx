        ...
        <header className="h-14 border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            <Link to="/" className="flex items-center gap-2">
              <div className="size-9 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center text-white font-bold shadow-lg shadow-blue-500/20">
                D
              </div>
            </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              title="TaskFlow"
            >
              <span className="size-6 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold">T</span>
            </a>
            <ThemeToggle />
            {isAuthenticated && (
              <Button
